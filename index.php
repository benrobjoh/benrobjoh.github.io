	...
	<p>Upon graduation from Elizabethtown College, Ben began graduate school at the University of North Carolina at Chapel Hill. He graduated with an MS in economics in December 2011. At UNC, he studied applied microeconomics and wrote a Master's paper titled <a href="http://benrobjoh.com/education/unc/Student%20Debt.pdf" onClick = "_gaq.push(['_trackEvent', 'Downloads', 'PDF', 'Student Debt: Who Borrows?']);">"Student Debt: Who Borrows?"</a>. He took courses in health economics, labor economics, empirical industrial organization, and econometrics.</p>
			...
			<div id="etown" class="school">
				...
				<ul>
					<li>Elizabethtown College Scholarship Day
						<ul>
							<li><em>The Politics of Global Warming</em> (2008)</li>
							<li><em>How Twentieth Century Spanish History Explains the Rivalry Between Real Madrid CF and FC Barcelona</em> (2009)</li>
							<li><em>The Economics of College Tuition and Financial Aid</em> (2010)</li>
						</ul>
					</li>
					<li>King's College Global Landscapes Conference
						<ul>
							<li><em>The Economics of College Tuition and Financial Aid</em> (2010)</li>
						</ul>
					</li>
					<li>EPaDel Mathematical Association of America Conference
						<ul>
							<li><em>History of Baseball Statistics</em> (2010)</li>
						</ul>
					</li>
				</ul>
				...
				<ul>
					...
					<li>Distinguished Student of the Year nominee</li>
		...
		<section id="certification">
			...
			<ul>
				...
				<li><a href="images/saas2.pdf">CS169.2x, Engineering Long-Lasting Software</a>
					<ul>
		...
		<section id="work">
			...
			<ul>
				<li>Teaching Assistant, 2010-2012
					<ul>
						<li><b>Econ 410 Intermediate Microeconomic Theory</b>, spring 2012: ran weekly review sessions to answer student questions, graded homework and exams</li>
						<li><b>Econ 101 Introduction to Economics</b>, fall 2011: Taught three recitation sections, held office hours, created exam questions, graded exams, facilitated logistics associated with running a 400-student class</li>
						<li><b>Econ 460 Economic Development</b>, spring 2011: Graded homework</li>
						<li><b>Econ 423 Financial Markets</b>, fall 2010: Graded homework and exams, graded weekly reports associated with stock market investment project</li>
					</ul>
			...
			<h2>Arch Insurance Group, New York, NY</h2>
			<ul>
				<li>Actuarial Intern, summer 2009
					<ul>
						<li>Blended industry data with Arch loss experience to select Loss Development Factors, set up Arch LDF Library, presented findings to Corporate Actuarial group</li>
					</ul>
				</li>
			</ul>
			<h2>Hempfield Area Recreation Commission, Landisville, PA</h2>
			<ul>
				<li>National Junior Tennis League Instructor, summer 2004-2008, 2010-2012
					<ul>
						<li>Taught tennis to children ranging from age five to fifteen; managed an assistant instructor; constructed each day's lesson with age-appropriate tennis activities</li>
					</ul>
				</li>
			</ul>
			<h2>Department of Mathematical Sciences, Elizabethtown College</h2>
			<ul>
				<li>Math Lab Tutor, 2008-2009
					<ul>
						<li>Assisted students with mathematics homework</li>
					</ul>
				</li>
			</ul>		
		</section>
...
*/
			...
			$('#tuitionabstractlink').click(function() {
				$('#tuitionabstract').slideToggle(1000)
			});
		});
	</script>
</body>
